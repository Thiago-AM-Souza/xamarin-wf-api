namespace CadastroDesktop.Views.ClienteCollectionView {
    partial class ClienteCollectionView {
		...
		private void InitializeComponent() {
			...
			this.clienteCollectionViewBindingSource.DataSource = typeof(CadastroDesktop.Model.Cliente);
			...
			this.gridView.PopulateColumns(typeof(CadastroDesktop.Model.Cliente),parameters);
		    // 
            // mvvmContext
            // 
